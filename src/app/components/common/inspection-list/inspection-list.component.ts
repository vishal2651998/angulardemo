...
export class InspectionListComponent implements OnInit {
  ...
  @Output() inspectionComponentRef: EventEmitter<InspectionListComponent> = new EventEmitter();
  @Output() callback: EventEmitter<InspectionListComponent> = new EventEmitter();
  ...
  ngOnInit(): void {
    ...
    this.inspectionComponentRef.emit(this);
    ...
    this.shopListColumns = [
      ...
      {field: 'auditChecks', header: 'Inspections', columnpclass: 'w8 header thl-col-8'},
      {field: 'auditStatus', header: 'Remedy Status', columnpclass: 'w9 header thl-col-9'}
    ];
    this.wfListColumns = [
    ...
    this.commonApi.getAuditList(auditData).subscribe((response) => {
      ...
      switch(this.view) {
        ...
        case 3:
          ...
          this.auditInfo = this.auditWorkFlowData.auditInfo;
          this.breadcrumbs[breadcrumbIndex-1].name =  this.auditInfo.auditName;
          ...
          this.breadcrumbs[breadcrumbIndex].name =  this.auditWorkFlowData.shopName;
          this.breadcrumbs[breadcrumbIndex].visible =  true;
          break;
        case 4:
  ...
  breadcrumb(action) {
    ...
    switch(action) {
      case 'back':
        ...
        switch(this.view) {
          case 1:
            apiFlag = (this.auditListData.length == 0) ? true : apiFlag;
            if(!apiFlag) {
              setTimeout(() => {
                this.loadAuditChart(this.auditChartData);
              }, 200);
            ...
            break;
          case 2:
            apiFlag = (this.auditShopListData.length == 0) ? true : apiFlag;
            break;
        }
        break;
      case 'landing':
