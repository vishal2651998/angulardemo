...
@Component({
  selector: 'app-recent-macros-widgets',
  templateUrl: './recent-macros-widgets.component.html',
  styleUrls: ['./recent-macros-widgets.component.scss']
})
export class RecentMacrosWidgetsComponent implements OnInit {
  ...
  ngOnInit(): void {
   ...
   var landingpage_attr1=localStorage.getItem('landingpage_attr25');
