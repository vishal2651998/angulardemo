...
@Component({
  selector: 'app-my-pinned-content',
  templateUrl: './my-pinned-content.component.html',
  styleUrls: ['./my-pinned-content.component.scss'],
...
export class MyPinnedContentComponent implements OnInit {
...
public collabticDomain: boolean = false;
  ...
  ngOnInit(): void {
    ...
    var landingpage_attr3=localStorage.getItem('landingpage_attr10');
...
this.getrecentViews('');
  ...
  apiFormData.append('type', "4");  // recent tech info
