...
export class FilterComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (!this.filterLoading) {
      ...
      this.filterHeight = this.filterOptions["filterHeight"] - 280;
      ...
      switch (access) {
        case "summary":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("dashFilter")
          );
          break;
        case "dealerUsage":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("dealerFilter")
          );
          break;
        case "escModel":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("escModelFilter")
          );
          break;
        case "escZone":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("escZoneFilter")
          );
          break;
        case "threads":
          this.getFilteredValues = JSON.parse(
        ...
        case "serviceProbing":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("serviceFilter")
          );
          break;
        case "gtsFilter":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("gtsFilter")
          );
          break;
        case "zoneMetrics":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("zoneMetricsFilter")
          );
          break;
        case "areaMetrics":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("areaActivityFilter")
          );
          break;
        case "userMetrics":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("userActivityFilter")
          );
          break;
        case "gtsUsage":
        case "gtsDealer":
          this.getFilteredValues = JSON.parse(
            localStorage.getItem("gtsUsageFilter")
          );
          break;
      }
      let getFilteredValues = this.getFilteredValues;
        ...
        for (let opt of options) {
          ...
          switch (wid) {
            ...
            case 2:
              ...
              if (getFilteredValues != null) {
                this.userTypeValue =
                  getFilteredValues.userType == undefined ||
                  getFilteredValues.userType == "undefined"
                    ? this.userTypeValue
                    : getFilteredValues.userType[0];
              }
            ...
            case 4:
              ...
              this.monthId = wid;
              this.filterMonthValue = opt.value;
              this.getMonthList();
              break;
            case 5:
            ...
            case 8:
              ...
              if (getFilteredValues != null) {
                this.dealerValue =
                  getFilteredValues.dealerCode == undefined ||
                  getFilteredValues.dealerCode == "undefined"
                    ? this.dealerValue
                    : getFilteredValues.dealerCode;
              }
            ...
            case 11:
              ...
              if (getFilteredValues != null) {
                this.modelValue =
                  getFilteredValues.models == undefined ||
                  getFilteredValues.models == "undefined"
                    ? this.modelValue
                    : getFilteredValues.models;
              }
              this.filteredData["modelName"] = this.modelValue;
              this.filteredModels = this.filteredData["modelName"];
              //let mlist = [{'modelName': 'Select Models', 'modelCode': ''}];
              let mlist = [];
              for (let escMod of escModelListData) {
                let code = escMod.name;
                let name = escMod.name;
                mlist.push({
                  modelName: code + " - " + name,
                  modelCode: code,
                });
            ...
            case 13:
              ...
              if (getFilteredValues != null) {
                this.userValue =
                  getFilteredValues.userId == undefined ||
                  getFilteredValues.userId == "undefined"
                    ? this.userValue
                    : getFilteredValues.userId;
              }
  ...
  getMonthList() {
    ...
    if (getFilteredValues != null) {
      this.filterMonthValue =
        getFilteredValues.month == undefined ||
        getFilteredValues.month == "undefined"
          ? this.filterMonthValue
          : getFilteredValues.month;
    }
  ...
  filterChange(id, value) {
    switch (id) {
      ...
      case 7.4:
        ...
        territoryApiData.territoryValue =
          this.territoryValue == "Select Territories"
            ? ""
            : this.territoryValue;
        this.geoTownFilter = false;
  ...
  selectedAreas(value) {
    ...
    this.filterChange(this.areaId, value);
  }

  // Filtered Terriroties
  selectedTerritories(value) {
    value = value == "Select Territories" ? "" : value;
    this.filterChange(this.territoryId, value);
  }

  // Filtered Towns
  selectedTowns(value) {
    //value = (value == "Select Towns") ? "" : value;
    this.filterChange(this.townId, value);
  }

  // Filtered Models
  selectedModels(items) {
    this.filteredModels = items;
    this.filteredData["modelName"] = this.filteredModels;
  }
