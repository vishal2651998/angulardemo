...
@Component({
  selector: 'app-gts-usage',
  templateUrl: './gts-usage.component.html',
  styleUrls: ['./gts-usage.component.scss']
})
export class GtsUsageComponent implements OnInit {

  public title: string = "GTS Usage";
  public headTitle: string = "GTS Usage";
  public headerFlag: boolean = false;
  public countryId;
  public domainId;
  public userId;
  public groupId: number = 9;
