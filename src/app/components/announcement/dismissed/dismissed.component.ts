...
@Component({
  selector: 'app-dismissed',
  templateUrl: './dismissed.component.html',
  styleUrls: ['./dismissed.component.scss']
})
export class DismissedComponent implements OnInit {

  public title:string = 'Dismissed Announcements';
  ...
  public announceType: string = "dismiss";
  ...
  applyFilter(filterData) {
    ...
    if(!resetFlag) {
      ...
      localStorage.setItem('dismissedAnnouncementFilter', JSON.stringify(filterData));
      ...
      localStorage.removeItem('dismissedAnnouncementFilter');
      setTimeout(() => {
        this.resetFilter();  
      }, 100);
    }
