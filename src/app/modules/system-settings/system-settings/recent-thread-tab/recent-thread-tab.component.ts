...
@Component({
  selector: 'app-recent-thread-tab',
  templateUrl: './recent-thread-tab.component.html',
  styleUrls: ['./recent-thread-tab.component.scss']
})

export class RecentThreadTabComponent implements OnInit {
  ...
  systemSettings(){
    ...
    apiFormData.append('settingsId', "6");    
  ...
  onToggleBoxChange(settingsId,itemId,flag){
    ...
    apiFormData.append('systemSettingsId', '6');      
