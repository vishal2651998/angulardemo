...
export class ViewNewComponent implements OnInit,  OnDestroy{
        ...
        switch(action) {
          case 'post-new':
              ...
              if(response['nestedReply'] == "1"){
                ...
                this.getPostUpdateList(response['postId'],'refresh','replynew');
             }
             else{
              ...
              this.getPostUpdateList(response['postId'],'new');
            }
            break;
          case 'post-edit':
            if(response['nestedReply'] == "1"){
              //if(response['viewpage'] == "1"){
                ...
                this.postFixRefresh = true;
                this.getPostUpdateList(response['postId'],'edit','replyedit');
            }
            else{
              //if(response['viewpage'] == "1"){
                ...
                this.postFixRefresh = true;
                this.getPostUpdateList(response['postId'],'edit');
            }
            break;
        }
      }, 1000);
...
return;
   ...
   */
   ...
   if(bottom && (this.postReplyDesc=='') && (this.postDesc=='')  && this.replyTaggedUsers.length==0 && !uploaFlag && this.commentTaggedUsers.length==0)
   {
   ...
   data['actionType']=='thread-like' || data['actionType']=='thread-pin'  ){
    ...
    if(data['actionType']=='comment-edit' || data['actionType']=='comment-like' ){
      this.getPostUpdateList(data['postId'],'edit','','','','edit-silent-push');
      let data2 = {
        type1: '',
        type2: 'edit',
        postId: data['postId'],
    ...
    if(data['actionType']=='reply-edit' || data['actionType']=='reply-like' ){
      this.parentPostId=data['parentPostId'];
      this.getPostUpdateList(data['postId'],'edit','replyedit','','','edit-silent-push');
      let data2 = {
        type1: 'replyedit',
        type2: 'edit',
        postId: data['postId'],
   ...
   else
   {
     ...
     this.getPostUpdateList(data['postId'],'new','',fromPushData,PushColor,'comment');
   ...
   this.replyPush = true;
     ...
     this.parentPostId=data['parentPostId'];
     this.getPostUpdateList(data['postId'],'refresh','replynew',fromPushData,PushColor,'reply');
    // this.commonApi.ThreadDetailReplyNotification(data);
     ...
     else
     {
      ...
      localStorage.setItem('pushPostId',data['postId']);
       let PushColor='1';
       this.getPostUpdateList(data['postId'],'refresh','replynew','1',PushColor);
    // this.commonApi.ThreadDetailReplyNotification(data);
  ...
  this.threadsDetailAPIcall=this.threadPostService.getthreadDetailsios(apiFormData,objData).subscribe(res => {
    ...
    if(res.status=='Success'){
      ...
      if(this.apiUrl.enableAccessLevel){
        this.accessLevel =  res.accesslevel != undefined ?  res.accesslevel : defaultAccessLevel;
      }
      else{
    ...
    if(this.CBADomainOnly){
      this.threadViewData.teamAssistTranslate = this.threadViewData.teamAssist;
    }
            ...
            if(initVal == 'init' ){
              ...
              if(pid == 0){
                for (let i in this.postData) {
                  ...
                  if((this.userId == this.postData[i].commentUserId || this.postData[i].ownerAccess == 1 || this.roleId == '10' || this.roleId == '3' || this.roleId == '2')){
          ...
          this.postLoading = false;
            ...
            if(this.postDataLength>0){
              for (let i in this.postLists) {
                ...
                this.postLists[i].enableActionButton = false;
                ...
                if(this.postReplyDataLength>0){
                    ...
                    for (let pr in this.postReplyLists) {
                      ...
                      if(this.postReplyLists[pr].replyLikedUsers != undefined){
                        this.postReplyLists[pr].likeStatus = 0;
                        for(let a in this.postReplyLists[pr].replyLikedUsers) {
                          if(this.postReplyLists[pr].replyLikedUsers[a] == this.userId) {
                            this.postReplyLists[pr].likeStatus = 1;
                          }
                        }
                      }
                      ...
                      if(this.postReplyLists[pr].owner  == this.postReplyLists[pr].replyUserId){
                      ...
                      if((this.userId == this.postReplyLists[pr].replyUserId || this.postReplyLists[pr].ownerAccess == 1 || this.roleId == '10' || this.roleId == '3' || this.roleId == '2')){
...
this.postData[i].activeBorder = false;
  ...
  getPostListSolr(postListData,othertype='')
  {
    ...
    for (let i in this.postLists) {
      ...
      this.postLists[i].postStatus = this.postLists[i].commentPostStatus;
      this.postLists[i].postType = this.postLists[i].commentPostType;
      if(this.postLists[i].owner  == this.postLists[i].commentUserId){
        this.postLists[i].threadOwnerLabel = true;
      }
      this.postLists[i].actionDisable = false;
      if(this.userId == this.postLists[i].commentUserId || this.postLists[i].ownerAccess == 1){
     ...
     this.postLists[i].remindersData = this.postLists[i].remindersData != '' && this.postLists[i].remindersData != 'undefined' && this.postLists[i].remindersData != undefined ? this.postLists[i].remindersData : '';
      ...
      if(this.postReplyDataLength>0){
        ...
        for (let prl in this.postReplyLists) {
          ...
          if(this.postReplyLists[prl].owner  == this.postReplyLists[prl].replyUserId){
             ...
             if(this.postFixDataLength>0){
               ...
               for (let i in this.postFixLists) {
                ...
                else
                {
                 ...
                 if(this.postFixLists[i].owner  == this.postFixLists[i].commentUserId){
              ...
              /* this.postFixLists[i].remindersData = this.postFixLists[i].remindersData != '' && this.postFixLists[i].remindersData != 'undefined' && this.postFixLists[i].remindersData != undefined ? this.postFixLists[i].remindersData : '';
               ...
               else
               {
                ...
                this.postFixLists[i].action = 'view';
                this.postFixLists[i].threadOwnerLabel = false;
                if(this.postFixLists[i].owner  == this.postFixLists[i].replyUserId){
                  this.postFixLists[i].threadOwnerLabel = true;
                }
                this.postFixLists[i].actionDisable = false;
    ...
    if(currentStatus != postStatus){
      ...
      this.threadPostService.solutionStatusAPI(apiFormData).subscribe(res => {
          if(res.status=='Success'){
            ...
            apiDatasocial.append('threadId', this.threadId);
            apiDatasocial.append('userId', this.userId);
            apiDatasocial.append('action', 'bulbStatus');
            let platformIdInfo = localStorage.getItem('platformId');
...

           {
            ...
            //setTimeout(() => {
              if(action  == 'nested-reply-edit'){
                ...
                this.postFixRefresh = true;
                //this.getThreadInfo('edit',postId,'replyedit');
                this.getPostUpdateList(postId,'edit','replyedit','1','','');
                let data = {
                  type1: 'replyedit',
                  type2: 'edit',
                  postId: postId,
                ...
                this.getPostUpdateList(postId,'edit','','1','','');
                let data = {
                  type1: '',
                  type2: 'edit',
                  postId: postId,
      ...
      for (let i in this.postData) {
        if(this.postData[i].postId == ppId){
          this.postData[i].commentNestedReplies.forEach((element,index)=>{
            //console.log(element.postId,postId);
          ...
          if(this.postData[i].replyIdArr) {
            ...
            if(this.postData[i].replyIdArr.length>0) {
              ...
              this.getPostUpdateList(prevId,'refresh','replynew','','','reply');
            }
            else{
              if(this.postData[i].deleteFlag == "1"){
