...
@Component({
  ...
  styleUrls: ['./view-v2.component.scss'],
  providers: [MessageService]
})
export class ViewV2Component implements OnInit,  OnDestroy{
        ...
        if(this.threadViewData != ''){
          ...
          if(this.techSupportFlag && this.threadViewData.newThreadTypeSelect !='share'){
            ...
            if(this.threadViewData.techSupportAssignedUserIdStr == '0'){
              ...
              this.threadViewData.assignedToId = this.assignedToId;
              this.threadViewData.assignedToName = this.assignedToName;
              this.threadViewData.assignedToProfile = this.assignedToProfile;
              ...
              if(pid == 0){
                for (let i in this.postData) {
                  ...
                  if(this.userId == this.postData[i].commentUserId){
                    ...
                    if( this.postData[i].automatedMessageStr=='1' &&  this.postData[i].automatedMessageStr != undefined)
                    {
                      this.postData[i].editDeleteAction = false;
                    }
    ...
    for (let i in this.postLists) {
      ...
      if(this.userId == this.postLists[i].commentUserId){
        this.postLists[i].editDeleteAction = true;
                    ...
                    if( this.postLists[i].automatedMessageStr !=undefined && this.postLists[i].automatedMessageStr=='1')
                    {
                      this.postLists[i].editDeleteAction = false;
                    }
      ...
      console.log(this.postLists[i].commentContent)
     if(this.postLists[i].commentContent != undefined){
      let contentWeb1 = '';
      ...
      this.postLists[i].contentWeb = this.postLists[i].commentContent;
     }
    ...
    for (let i in this.postLists) {
      ...
      if(this.userId == this.postLists[i].commentUserId){
        this.postLists[i].editDeleteAction = true;
                    ...
                    if( this.postLists[i].automatedMessageStr=='1' && this.postLists[i].automatedMessageStr!=undefined)
                    {
                      this.postLists[i].editDeleteAction = false;
                    }
    ...
    this.threadPostService.newReplyPost(apiFormData).subscribe(res => {
      ...
      //this.bodyElem.classList.remove(this.bodyClass2);
        if(res.status=='Success'){
          ...
          if(this.diagnationDomain && closeStatus == 'yes'){              
            const apiFormData = new FormData();      
            apiFormData.append('apiKey', Constant.ApiKey);
            apiFormData.append('domainId', this.domainId);      
            apiFormData.append('userId', this.userId);
            if(this.threadViewData.workOrder){
              apiFormData.append('workOrderId', this.threadViewData.workOrder);
            }
            this.repairOrderApi.completeSupportTicket(apiFormData).subscribe(res => {
              ...
              if(res.status=='Success'){                
                ...
                pushFormData.append('makeName', this.threadViewData.genericProductName);                  
                pushFormData.append('formWorkOrder', '1');
                pushFormData.append('actionType', 'completeOrder');
                pushFormData.append('threadId', this.threadId);
                pushFormData.append('postId', this.threadViewData.postId);  
                pushFormData.append('workOrderId',this.threadViewData.workOrder);
