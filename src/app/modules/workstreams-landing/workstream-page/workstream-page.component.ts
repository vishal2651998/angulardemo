...
@Component({
  selector: 'app-workstream-page',
  templateUrl: './workstream-page.component.html',
  styleUrls: ['./workstream-page.component.scss']
})
export class WorkstreamPageComponent implements OnInit {
