...
@Component({
  selector: 'app-shop-detail-inspection',
  templateUrl: './shop-detail-inspection.component.html',
  styleUrls: ['./shop-detail-inspection.component.scss']
})
export class ShopDetailInspectionComponent implements OnInit {
  regionName:string="";
