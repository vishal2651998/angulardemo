...
@Component({
  selector: 'app-all-tools-headquarter',
  templateUrl: './all-tools-headquarter.component.html',
  styleUrls: ['./all-tools-headquarter.component.scss']
})
export class AllToolsHeadquarterComponent implements OnInit {
  ...
  addTools(){
    ...
    modalRef.result.then(e=>{
      if(this.toolsListPageRef){
        this.toolsListPageRef.lazyLoadingListner();
  ...
  toolsIndexListPageCallback(data){
    ...
    this.locationToolsFlag = this.toolsListPageRef.locationToolsFlag;
