...
@Component({
  selector: 'app-system-settings-sidebar',
  templateUrl: './system-settings-sidebar.component.html',
  styleUrls: ['./system-settings-sidebar.component.scss']
})
export class SystemSettingsSidebarComponent implements OnInit {
  public sconfig: PerfectScrollbarConfigInterface = {};
  sidebarRef: SidebarComponent;

  viewType = "LIST"
  @Input("selectedTab") selectedTab:string = "banner-settings"
  ...
  router.events.forEach((event) => {
    if(event instanceof NavigationStart) {
      ...
      if(lastUrlSegment==="system-settings"){
        this.selectedTab="banner-settings"
      }
    }
  });
  }
