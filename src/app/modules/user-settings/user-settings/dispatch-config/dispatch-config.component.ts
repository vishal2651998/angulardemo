...
@Component({
  selector: 'app-dispatch-config',
  templateUrl: './dispatch-config.component.html',
  styleUrls: ['./dispatch-config.component.scss']
})
export class DispatchConfigComponent implements OnInit {
  @Input() menuId: any;
  public sconfig: PerfectScrollbarConfigInterface = {};
  public bodyClass: string = "dispatch-config";
  ...
  getDistpatchNotificationConfig(action = '', actionItems:any = '') {
    ...
    apiFormData.append('contentTypeId', ContentTypeValues.Dispatch);
